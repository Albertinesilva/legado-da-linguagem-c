...
//IMPRIME A INSCRI플O DO CANDIDATO COM OS DADOS CADASTRADOS.
void imprime_inscricao_do_candidato(struct inscrever_candidato candidato[],int quant_candidato);
//ALTERA A INSCRI플O DO CANDIDATO COM A CONFIRMA플O DO CPF CADASTRADO.
...
//FUN플O, QUE FAZ O CALCULO PARA SEPARAR (VAGAS POR TIPOS)...
void visualizar_vaga_portipo(struct cadastro_curso cad[],int totcursos);
//FUN플O QUE IMPRIME VAGAS POR TIPO
void imprime_tipos_de_vagas(struct cadastro_curso cad[],int totcursos);
//______________________________________________________________________________________________________________
//ESTRUTURA QUE RECEBE INSTRU합ES SOBRE CANDIDATO TIPO VAGA c1. PARA GERAR LISTA DE CLASSIFICA플O:
struct tipo_vaga_c1
{
    float nota_c1;
    char cpf_c1[20];
...
//RECEBE OS DADOS CADASTRADOS PELOS CANDIDATOS,QUE CONCORREM AO TIPO DE VAGA((C1) RENDA <= 1,5 SAL?IOS)
...
//GERA A LISTA DE CLASSIFICA플O DO CANDIDATO: INFORMA SE O CANDIDATO FOI APROVADO OU SE ESTA NA LISTA DE ESPERA.
...
//______________________________________________________________________________________________________________
//ESTRUTURA QUE RECEBE INSTRU합ES SOBRE CANDIDATO TIPO VAGA c2. PARA GERAR LISTA DE CLASSIFICA플O
struct tipo_vaga_c2
{
    float nota_c2;
    char cpf_c2[20];
...
//RECEBE OS DADOS CADASTRADOS PELOS CANDIDATOS,QUE CONCORREM AO TIPO DE VAGA((C2) RENDA > 1,5 SAL?IOS)
...
//ESTRUTURA QUE RECEBE INSTRU합ES SOBRE CANDIDATO TIPO VAGA PCD. PARA GERAR LISTA DE CLASSIFICA플O
...
//ESTRUTURA QUE RECEBE INSTRU합ES SOBRE CANDIDATO TIPO VAGA A. PARA GERAR LISTA DE CLASSIFICA플O
struct tipo_vaga_a
{
    float nota_a;
    char cpf_a[20];
...
//RECEBE OS DADOS CADASTRADOS PELOS CANDIDATOS,QUE CONCORREM AO TIPO DE VAGA((A) AMPLA CONCORR?CIA).
...
//RECEBE DADOS DA STRUCT(C1,C2,PCD,A),PARA GERAR LISTA DE CLASSIFICA플O
...
int main()
{
    ...
    //VARI?EL DO TIPO BOLEANA:
    bool sair=true;//SAI DO PROGRAMA SE O USU?IO DIGITAR A OP플O 8.
//_____________________________________________________________________________________________________________
    //VARI?EIS DO TIPO INTEIRO:
    int opcao=0;//UTILIZADA PARA ESCOLHER RECEBER A OP플O DESEJADA DO USU?IO.
    int numinscricao=0;//QUANTIDADE DE INSCRI플O DE CANDIDATOS
    int quant_cursos=-1;//QUANTIDADE DE CURSOS CADASTRADOS PELO USU?IO.
    char c[20];
//______________________________________________________________________________________________________________
    ...
    /**********************************
     *STRUCT DE INSCRI플O DO CANDIDATO*
     **********************************/
...
//********************************************************************************************
    ...
    while(sair)
    {
        ...
        case 1:
            ...
            quant_cursos++;
            //FUN플O QUE RETORNA COM A QUANTIDADE DE CURSOS CADASTRADOS
            quant_cursos=cadastrar_cursos_de_TI(cad,quant_cursos);

            break;

        //ALTERA OS CURSOS CONFORME VONTADE DO USU?IO
        case 2:
        ...
        case 3:
            ...
            //FUN플O QUE FAZ O CALCULO DE VAGAS POR TIPOS DE COTA.
            visualizar_vaga_portipo(cad,quant_cursos);
            //FUN플O QUE IMPRIME TIPOS DE VAGAS.
            imprime_tipos_de_vagas(cad,quant_cursos);

            break;

        //INSCRI플O DO CANDIDATO
        case 4:
        ...
        //ALTERA A INSCRI플O DO CANDIDATO.
        case 5:
...
int imprime_menu(int totcursos)
{
    ...
    if(totcursos==-1)
    {
        ...
        printf("\t\t\t\t\t                     {Apos ler o vers?ulo, digite qualquer tecla!}\n");
        printf("                                                              ********************************************");
    ...
    while(continuar_cad_cursos)
    {
        ...
        for(i=0; i<=totcursos; i++)
        {
            ...
            while(codigo_e_vaga)
            {
                ...
                //SO SAI DO LA? DE REPETI플O QUANDO O USU?IO DIGITA N?ERO, PARA O CODIGO DO CURSO.
                codigo_certo=true;
                y=0;
                do
                {
                    printf("\n\t _________________________\n");
                    printf("\t|Informe o c?igo do curso| ");
                    printf("\n\t|_________________________| ");
                    printf("\n\t|*******|*****************|");
                    printf("\n\t|ENTRADA|-->  ");
                    setbuf(stdin,NULL);
                    ...
                    else
                    {
                        ...
                        system(comando);
                        printf("\n\a|*********************************************************************************************************************************************************************|\n");
                        printf("|                                                                O CODIGO DO CURSO N? PODE SER LETRA                                                                 |\n");
                ...
                codigo_repetido=0;
                //CONFIRMA SE O CODIGO DO CURSO   REPETIDO
                for(y=0; y<=totcursos; y++)
                {
                    ...
                    if(codigo_repetido==2)
                    {
                        ...
                        printf("\n\a|*********************************************************************************************************************************************************************|\n");
                        printf("|                                                     ESSE C?IGO J?FOI CADASTRADO, FAVOR INFORME OUTRO C?IGO!                                                      |\n");
                        printf("|_____________________________________________________________________________________________________________________________________________________________________|\n");
                        printf("|*********************************************************************************************************************************************************************|\n\n");
                        codigo_e_vaga=true;
                        break;
            ...
            do
            {
                ...
                else
                {
                    ...
                    printf(" |**********************************************************************************************************************************************************************|");
                    printf("|                                                               N? EXISTE NOME DE CURSOS COM N?EROS                                                                  |");
            ...
            //QUANTIDADE DE VAGAS N? PODE SE <=0.
            ...
            while(quantidade_vagas)
            {
                ...
                if(cad[totcursos].quant_vagas<=0)
                {
                    ...
                    printf("\n\a|*********************************************************************************************************************************************************************|\n");
                    printf("|                                                      O CURSO N? PODE TER QUANTIDADE DE VAGAS = [%d]                                                                 |\n",cad[totcursos].quant_vagas);
                    printf("|_____________________________________________________________________________________________________________________________________________________________________|\n");
                    printf("|*********************************************************************************************************************************************************************|\n\n");
                    quantidade_vagas=true;
                }
            ...
            do
            {
                ...
                printf("\n|__________________________________________________________|Escolha a op豫o do turno para o curso|____________________________________________________________________|\n");
                printf("|**********************************************************|*************************************|********************************************************************|\n");
                printf("\n\n\t{***************}");
                printf("\n\t{1 - Matutino   }");
                printf("\n\t{2 - Vespertino }");
...
void alterar_curso(struct cadastro_curso cad[],int totcursos)
{
    ...
    while(codigo)
    {
        ...
        do
        {
            ...
            printf("\t|Digite o codigo do curso, que voc?deseja alterar os dados cadastrados | ");
            printf("\n\t|_______________________________________________________________________|  ");
            printf("\n\t|*******|**************************************************************|");
            printf("\n\t|ENTRADA|-->  ");
            setbuf(stdin,NULL);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(opcao_alterar_cadastrocurso==5)
                        {
                            ...
                            system(comando);
                            printf("\n\a|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");
                            printf("|                                                                  VOC?SAIU DA OP플O ALTERAR CURSOS!                                                                 |");
                            printf("\n|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");
                            codigo=false;
                        }
                    }
...
void imprime_inscricao_do_candidato(struct inscrever_candidato candidato[],int quant_candidato)
{
    ...
    printf("\t|Inscri豫o realizada com sucesso!                              |");
    printf("\n\t****************************************************************\n\n");

    printf("\t************************************************");
    printf("\n\t|Depois de conferir sua inscri豫o,digite enter!|");
    printf("\n\t************************************************");
    setbuf(stdin,NULL);
    t=getchar();
    system("cls");
...
void imprime_tipos_de_vagas(struct cadastro_curso cad[],int totcursos)
{
    ...
    for(int i=0; i<=totcursos; i++)
    {
        ...
        printf("\t\t\t\t\t\t|                                                              |\n");
        printf("\t\t\t\t\t\t****************************************************************\n");
        printf("\t\t\t\t\t\t|Conta escola p?lica: %.0f vagas                                |",cad[i].c);
        printf("\n\t\t\t\t\t\t|                                                              |");
        printf("\n\t\t\t\t\t\t|1?- Renda maior ou igual a 1 sal?io minimo: C1 = %.0f vagas    |",cad[i].c1);
        printf("\n\t\t\t\t\t\t|2?- Renda menor que 1 sal?io minimo: C2 = %.0f vagas           |",cad[i].c2);
        printf("\n\t\t\t\t\t\t|______________________________________________________________|\n");
        printf("\t\t\t\t\t\t|**************************************************************|\n");
        printf("\t\t\t\t\t\t|______________________________________________________________|");
        printf("\n\t\t\t\t\t\t****************************************************************\n");
        printf("\t\t\t\t\t\t|3?- Pessoas com defici?cia: PCD = %.0f vagas                   |",cad[i].pcd);
        printf("\n\t\t\t\t\t\t|______________________________________________________________|");
        printf("\n\t\t\t\t\t\t****************************************************************\n");
        printf("\t\t\t\t\t\t|4?- Ampla concorr?cia: A = %.0f vagas                         |",cad[i].a);
        printf("\n\t\t\t\t\t\t|______________________________________________________________|");
        printf("\n\n|_____________________________________________________________________________________________________________________________________________________________________|\n");
        printf("|*********************************************************************************************************************************************************************|\n");
...
int inscricao_do_candidato(struct inscrever_candidato candidato[],struct cadastro_curso cad[],int quant_candidato,int totcursos)
{
    ...
    //SE N? EXISTIR CURSO CADASTRADO, AVISA AO USU?IO
    if(totcursos==-1)
    {
        system("cls");
        strcpy(comando,"color 4f");
        system(comando);
        printf("\n\a|*********************************************************************************************************************************************************************|\n");
        printf("|                                                               N? EXISTE CURSO CADASTRADO NO MOMENTO!                                                               |\n");
        printf("|_____________________________________________________________________________________________________________________________________________________________________|\n");
        printf("|*********************************************************************************************************************************************************************|\n\n");
        printf("\n\t _____________________________________________");
        printf("\n\t|  N? existe curso cadastrado no momento!    |");
        printf("\n\t**************|Fique esperto!|*****************");
        printf("\n\t              ****************");
        printf("\n\t               Digite ENTER!");
        setbuf(stdin,NULL);
    ...
    else
    {
        ...
        do
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    system(comando);
                    printf("\n|*********************************************************************************************************************************************************************|\n");
                    printf("|                                                                   N? EXISTE NOME COM N?EROS                                                                       |\n");
                    printf("|_____________________________________________________________________________________________________________________________________________________________________|\n");
                    printf("|*********************************************************************************************************************************************************************|\n\n");
                }
            ...
            //USU?IO SO PODE USAR N?ERO PARA O CPF.
            do
            {
                printf("\n\t _________________");
                printf("\n\t{*****************}\n");
                ...
                else
                {
                    ...
                    system(comando);
                    printf("\n\a|*********************************************************************************************************************************************************************|\n");
                    printf("|                                                                 N? EXISTE CPF COM LETRAS                                                                           |\n");
                    printf("|_____________________________________________________________________________________________________________________________________________________________________|\n");
                    printf("|*********************************************************************************************************************************************************************|\n\n");
            ...
            x=0;
            //BLOQUEIO PARA INSCRI플O DE CPF REPETIDO.SO   PERMITIDO UM CPF POR INSCRI플O.
            ...
            if(existe_cpf==1)
            {
                ...
                printf("|*********************************************************************************************************************************************************************|\n");
                printf("|                                                                  CPF %s INV?IDO!",candidato[quant_candidato].cpf);
                printf("\n|                                                         EXISTE UM CPF INSCRITO COM ESSE N?ERO!                                                                     |");
                printf("\n|_____________________________________________________________________________________________________________________________________________________________________|\n");
                printf("|*********************************************************************************************************************************************************************|");
                existe_cpf=0;
            }
        ...
        do
        {
            ...
            printf("\t{Digite a op豫o do curso desejado}");
            printf("\n\t{________________________________}");
            printf("\n\t|*******|************************ ");
            printf("\n\t|ENTRADA|-->  ");
            setbuf(stdin,NULL);
        ...
        do
        {
            ...
            printf("\t{\t\tCOTA ESCOLA P?LICA                   }");
            printf("\n\t|                                                     |");
            printf("\n\t{_____________________________________________________}\n");
            printf("\t|1 - C1: Renda maior ou igual a R$1,5 sal?ios minimos|");
            printf("\n\t{_____________________________________________________}\n");
            printf("\t|2 - C2: Renda menor que R$1,5 sal?io minimo         |");
            printf("\n\t{_____________________________________________________}\n");
            printf("\t|_____________________________________________________|\n");
            printf("\t{3 - PCD: Pessoa com deficiencia                      }");
            printf("\n\t|_____________________________________________________|\n");
            printf("\t{_____________________________________________________}\n");
            printf("\t|4 - A: Ampla concorr?cia                            | ");
            printf("\n\t{_____________________________________________________}");
            printf("\n\t|*****************************************************|");
            printf("\n\t|ENTRADA|-->  ");
            ...
            {
                strcpy(candidato[quant_candidato].tipo_vaga,"C1: Renda maior ou igual a R$ 1,5 sal?ios");
            ...
            else
            {
                ...
                {
                    strcpy(candidato[quant_candidato].tipo_vaga,"C2: Renda menor que R$ 1,5 sal?ios");
                }
                else
                {
                    ...
                    {
                        strcpy(candidato[quant_candidato].tipo_vaga,"A: Ampla concorr?cia");
                    }
                }
            }
    ...
    do
    {
        while(alterar_inscricao)
        {
            ...
            if(realizar_alteracao=='n')
            {
                ...
                do
                {
                    ...
                    printf("\n\t|*************************************|\n");
                    printf("\t|Deseja realmente alterar a inscri豫o?|");
                    printf("\n\t|_____________________________________|");
                    printf("\n\t|*************************************|");
                    printf("\n\t|Digite: [s] para sim                 |");
                    printf("\n\t|Digite: [n] para n?                 |");
            ...
            if(realizar_alteracao=='s')
            {
                ...
                while(confirmar_cpf)
                {
                    ...
                    printf("\n\t{*******************************************}\n");
                    printf("\t{Informe o CPF que foi feito(a) a inscri豫o } ");
                    printf("\n\t{___________________________________________} ");
                    printf("\n\t|*******|***********************************");
                    printf("\n\t|ENTRADA|-->  ");
                    setbuf(stdin,NULL);
                    ...
                    //SE O CPF ESTIVER INSCRITO EM ALGUM CURSO, IMPRIME INSCRI플O DO CANDIDATO
                    ...
                    if(cpf_valido==0)
                    {
                        ...
                        printf("\n|_____________________________________________________________________________________________________________________________________________________________________|\n");
                        printf("|*********************************************************************************************************************************************************************|\n");
                        printf("|                                                                  CPF %s INV?IDO!                                                                            |",compararcpf);
                        printf("\n|                                                     N? EXISTE UM CPF INSCRITO COM ESSE N?ERO!                                                                     |");
                        printf("\n|_____________________________________________________________________________________________________________________________________________________________________|\n");
                        printf("|*********************************************************************************************************************************************************************|");
            ...
            if(realizar_alteracao=='s')
            {
                ...
                do
                {
                    ...
                    printf("\n\t|**********************************|");
                    printf("\n\t|QUAL DESSAS OP합ES DESEJA ALTERAR?|");
                    printf("\n\t|----------------------------------|");
                    printf("\n\t|__________________________________|\n");
                    printf("\t|1 - CURSO                         |");
                    printf("\n\t|----------------------------------|\n");
                ...
                if(opcao_alterar_curso==1)
                {
                    ...
                    do
                    {
                        ...
                        printf("\t{Digite a op豫o do curso que deseja alterar}");
                        printf("\n\t{__________________________________________}");
                        printf("\n\t|*******|********************************** ");
                        printf("\n\t|ENTRADA|-->  ");
                        setbuf(stdin,NULL);
                    ...
                    else
                    {
                        ...
                        if(opcao_alterar_curso==3)
                        {
                            ...
                            do
                            {
                                printf("\n\n\t _______________________________________________________________________");
                                printf("\n\t|***********************************************************************|\n");
                                printf("\t|   Digite a op豫o do curso,juntamente com o turno que deseja alterar   | ");
                                printf("\n\t|_______________________________________________________________________|  ");
                                printf("\n\t|*******|***************************************************************|");
                                printf("\n\t|ENTRADA|-->  ");
                                setbuf(stdin,NULL);
                                    ...
                                    do
                                    {
                                        ...
                                        if(opcao_tipo_vaga==1)
                                        {
                                            for(i=0; i<quant_candidato; i++)
                                            {
                                                if(strcmp(candidato[i].cpf,compararcpf)==0)
                                                {
                                                    strcpy(candidato[i].tipo_vaga,"C1: Renda maior ou igual a R$ 1,5 sal?ios");
                                        ...
                                        else
                                        {
                                            if(opcao_tipo_vaga==2)
                                            {
                                                for(i=0; i<quant_candidato; i++)
                                                {
                                                    if(strcmp(candidato[i].cpf,compararcpf)==0)
                                                    {
                                                        strcpy(candidato[i].tipo_vaga,"C2: Renda menor que R$ 1,5 sal?io");
                                            ...
                                            else
                                            {
                                                ...
                                                else if(opcao_tipo_vaga==4)
                                                {
                                                    for(i=0; i<=quant_candidato; i++)
                                                    {
                                                        if(strcmp(candidato[i].cpf,compararcpf)==0)
                                                        {
                                                            strcpy(candidato[i].tipo_vaga,"A: Ampla concorr?cia");
        ...
        else
        {
            do
            {
                ...
                printf("\n\t _____________________________________");
                printf("\n\t|*************************************|\n");
                printf("\t|  CONTINUAR ALTERANDO A INSCRI플O?   |");
                printf("\n\t|_____________________________________|");
                printf("\n\t|*************************************|");
                printf("\n\t|Digite: [s] para sim                 |");
                printf("\n\t|Digite: [n] para n?                 |");
    ...
    do
    {
        ...
        else
        {
            if(opcao==2)
            {
                ...
                {
                    system("cls");
                    printf("\n|_______________________________________________________________|C1: Renda maior ou igual a R$ 1,5 sal?ios|__________________________________________________________|\n");
                    printf("|*********************************************************************************************************************************************************************|\n");

                    for(i=0; i<quant_candidato; i++)
                    {
                        if(strcmp(candidato[i].tipo_vaga,"C1: Renda maior ou igual a R$ 1,5 sal?ios")==0)
                        {
                            printf("\t|_______________________________________________________\n");
                            printf("\t|*******************************************************|\n");
                            printf("\t|Nome: %s                                 \n\t|CPF: %s                                 \n\t|Curso: %s                                \n\t|Turno: %s                                \n\t|Tipo vaga: %s                            \n\t|Enem: %.2f                             "
                ...
                else
                {
                    ...
                    {
                        system("cls");
                        printf("\n|___________________________________________________________________|C2: Renda menor que R$ 1,5 sal?ios|_____________________________________________________________|\n");
                        printf("|*********************************************************************************************************************************************************************|\n");

                        for(i=0; i<quant_candidato; i++)
                        {
                            if(strcmp(candidato[i].tipo_vaga,"C2: Renda menor que R$ 1,5 sal?ios")==0)
                            {
                                printf("\t|_______________________________________________________\n");
                                printf("\t|*******************************************************|\n");
                                printf("\t|Nome: %s                                 \n\t|CPF: %s                                 \n\t|Curso: %s                                \n\t|Turno: %s                                \n\t|Tipo vaga: %s                            \n\t|Enem: %.2f                             "
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                system("cls");
                                printf("\n|_______________________________________________________________________|A: Ampla concorr?cia|_______________________________________________________________________|\n");
                                printf("|*********************************************************************************************************************************************************************|\n");

                                for(i=0; i<quant_candidato; i++)
                                {
                                    if(strcmp(candidato[i].tipo_vaga,"A: Ampla concorr?cia")==0)
                                    {
                                        printf("\t|_______________________________________________________\n");
                                        printf("\t|*******************************************************|\n");
                                        printf("\t|Nome: %s                                 \n\t|CPF: %s                                 \n\t|Curso: %s                                \n\t|Turno: %s                                \n\t|Tipo vaga: %s                            \n\t|Enem: %.2f                             "
            ...
            else
            {
                system("cls");
                printf("\n\a|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");
                printf("|                                                                  VOC?SAIU DA OP플O GERAR LISTA DE INSCRITOS!                                                       |");
                printf("\n|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");
            }
        }
...

{
    ...
    {
        if(strcmp(candidato[i].nome_curso,cad[opcaocurso-1].nome_curso)==0&&strcmp(candidato[i].tipo_vaga,"C1: Renda maior ou igual a R$ 1,5 sal?ios")==0)
        {
            ...
            strcpy(c1[cont].tipo_vaga_c1,"C1: Renda maior ou igual a R$ 1,5 sal?ios");
            cont++;
        }
...
void imprime_tipo_vaga_c1_por_curso_aprovados_e_lista_de_espera(struct cadastro_curso cad[],struct tipo_vaga_c1 c1[],int opcaocurso,int quant_candidatos,int totcursos)
{
    ...
    for(int x=0; x<quant_candidatos; x++)
    {
        ...
        if(strcmp(c1[x].tipo_vaga_c1,"C1: Renda maior ou igual a R$ 1,5 sal?ios")==0)
        {
            cont++;
        }
    }
    ...
    else
    {
        ...
        printf("\n\t|N? encontrou seu nome na lista de aprovado?|");
        printf("\n\t|*************|*******************************");
        printf("\n\t|Digite ENTER!|-->  ");
        setbuf(stdin,NULL);
        espera=getchar();
    ...
    printf("\n\t|N? fui eu que ordenei a voc?                               |");
    printf("\n\t|Seja forte e corajoso! N? se apavore nem desanime,          |\n");
    printf("\t|pois o Senhor,o seu Deus,estar?com voc?por onde voc?andar.|");
    printf("\n\t|*********|*************************************************  |");
    printf("\n\t[Josu?1:9]                                                   |");
    printf("\n\t***************************************************************\n\n");
...
void classificacao_por_curso_e_tipovaga_c2(struct inscrever_candidato candidato[],struct tipo_vaga_c2 c2[],struct cadastro_curso cad[],int quant_candidatos,int opcaocurso)
{
    ...
    for(i=0; i<quant_candidatos; i++)
    {
        if(strcmp(candidato[i].nome_curso,cad[opcaocurso-1].nome_curso)==0&&strcmp(candidato[i].tipo_vaga,"C2: Renda menor que R$ 1,5 sal?ios")==0)
        {
            ...
            strcpy(c2[cont].tipo_vaga_c2,"C2: Renda menor que R$ 1,5 sal?io");
            cont++;
    ...
    //FAZ A REORDENA플O DE NOME,NOTA E CPF
    for(l=0; l<cont; l++)
    {
        for(j=l+1; j<cont; j++)
        {
...
void imprime_tipo_vaga_c2_por_curso_aprovados_e_lista_de_espera(struct cadastro_curso cad[],struct tipo_vaga_c2 c2[],int opcaocurso,int quant_candidatos,int totcursos)
{
    ...
    for(int x=0; x<quant_candidatos; x++)
    {
        ...
        if(strcmp(c2[x].tipo_vaga_c2,"C2: Renda menor que R$ 1,5 sal?io")==0)
        {
            cont++;
        }
    }
...
//LISTA DE ESPERA
    ...
    printf("\n\t|Ao Rei eterno, o Deus ?ico, imortal e invis?el,|");
    printf("\n\t|seja honra e gloria para todo o sempre.Am?.     |\n");
    printf("\t|************|************************************|");
    printf("\n\t[Tim?eo 1:17]                                    |");
    printf("\n\t***************************************************\n\n");
...
//STRUCT TIPO_VAGA_PCD RECEBE DADOS DO CANDIDATO CONFORME A SUA INSCRI플O
    for(i=0; i<quant_candidatos; i++)
    {
    ...
    //FAZ A REORDENA플O DE NOTA,NOME E CPF
    for(l=0; l<cont; l++)
    {
        for(j=l+1; j<cont; j++)
        {
...
//LISTA DE ESPERA
    ...
    printf("\n\t _______________________________________________________________________");
    printf("\n\t|Ame o senhor, o seu Deus, de todo o seu cora豫o,                       |");
    printf("\n\t|de toda a sua alma, de todo o seu entendimeto e de todas as suas for?s|");
    printf("\n\t|O segundo ?este: Ame o seu pr?imo como a si mesmo.                   |");
    printf("\n\t|N? existe mandamento maior do que estes.                              |\n");
    printf("\t|***********************************************************************|");
    printf("\n\t[Marcos 12:30-31]                                                       |");
    printf("\n\t*************************************************************************\n\n");
}
...
//ABASTECE A STRUCT TIPO_VAGA_A
    for(i=0; i<quant_candidatos; i++)
    {
        if(strcmp(candidato[i].nome_curso,cad[opcaocurso-1].nome_curso)==0&&strcmp(candidato[i].tipo_vaga,"A: Ampla concorr?cia")==0)
        {
            ...
            strcpy(a[cont].tipo_vaga_a,"A: Ampla concorr?cia");
            cont++;
        }
        if(strcmp(candidato[i].nome_curso,cad[opcaocurso-1].nome_curso)==0)
        {
...
void imprime_tipo_vaga_a_por_curso_aprovados_e_lista_de_espera(struct cadastro_curso cad[],struct tipo_vaga_a a[],int opcaocurso,int quant_candidatos,int totcursos)
{
    ...
    for(int x=0; x<quant_candidatos; x++)
    {
        ...
        if(strcmp(a[x].tipo_vaga_a,"A: Ampla concorr?cia")==0)
        {
            cont++;
        }
    }
    ...
    printf("\n\t|E a perseveran? deve ter a豫o completa, a fim de que voc? sejam|");
    printf("\n\t|maduros e ?tegros, sem que falte a voc? coisa alguma.          |\n");
    printf("\t|*********|*******************************************************|");
    printf("\n\t[Tiago 1:4]                                                       |");
    printf("\n\t*******************************************************************\n\n");
}
...
void classificacao_por_tipovaga_c1(struct inscrever_candidato candidato[], struct tipo_vagac1 vaga_c1[],struct cadastro_curso cad[],int quant_candidato,int totcursos)
{
    ...
    for(i=0; i<quant_candidato; i++)
    {
        if(strcmp(candidato[i].tipo_vaga,"C1: Renda maior ou igual a R$ 1,5 sal?ios")==0)
        {
            ...
            strcpy(vaga_c1[cont].tipo_vaga_c1,"C1: Renda maior ou igual a R$ 1,5 sal?ios");
...
void classificacao_por_tipovaga_c2(struct inscrever_candidato candidato[], struct tipo_vagac2 vaga_c2[],struct cadastro_curso cad[],int quant_candidato,int totcursos)
{
    ...
    for(i=0; i<quant_candidato; i++)
    {
        if(strcmp(candidato[i].tipo_vaga,"C2: Renda menor que R$ 1,5 sal?ios")==0)
        {
            ...
            strcpy(vaga_c2[cont].tipo_vaga_c2,"C2: Renda menor que R$ 1,5 sal?ios");
...
//STRUCT TIPO_VAGA_PCD RECEBE DADOS DO CANDIDATO CONFORME A SUA INSCRI플O
    for(i=0; i<quant_candidato; i++)
    {
        if(strcmp(candidato[i].tipo_vaga,"A: Ampla concorr?cia")==0)
        {
            ...
            strcpy(vaga_a[cont].tipo_vaga_a,"A: Ampla concorr?cia");
...
void imprime_tipo_vaga_a_aprovados_e_lista_de_espera(struct cadastro_curso cad[],struct tipo_vagaa vaga_a[],int quant_candidato,int totcursos)
{
    ...
    printf("\n\n\n|________________________________________________________________________|A: AMPLA CONCORR?CIA|______________________________________________________________________|\n");
    printf("|*********************************************************************************************************************************************************************|\n");
...
void gerar_lista_de_classificacao(struct inscrever_candidato candidato[],struct cadastro_curso cad[],int quant_candidato,int totcursos)
{
    ...
    //SE N? OUVER CANDIDATO INSCRITO APARECE ESSA MENSAGEM
    if(quant_candidato<=0)
    {
        strcpy(comando,"color 4f");
        system(comando);
        printf("\n\n|\n__________________________________________________________________|N? EXISTE CANDIDATO INSCRITO!|__________________________________________________________________|\n");
        printf("|***************************************************************|************************************|***************************************************************|\n");
        continuar_classi=false;
    }

    //CANDIDATO ESCOLHE A OP??DO CURSO, QUE ELE SE ESCREVEU.
    while(continuar_classi)
    {

        printf("\n\n\t{*************************************************}");
        printf("\n\t{1 - Gerar Classifica豫o Por Curso e Tipo de Vaga }");
        printf("\n\t{2 - Gerar classifica豫o por Tipo de Vaga         }");
        printf("\n\t{3 - Gerar Classifica豫o geral                    }");
        printf("\n\t{4 - Sair                                         }");
        printf("\n\t|*******|*****************************************");
        printf("\n\t|ENTRADA|-->  ");
        setbuf(stdin,NULL);
        ...
        if(opcao==1)
        {
            ...
            do
            {
                ...
                printf("\n\t _____________________________________________");
                printf("\n\t{*********************************************}\n");
                printf("\t{   Qual desses CURSOS voc?esta concorrendo? } ");
                printf("\n\t{_____________________________________________} ");
                printf("\n\t|*******|*************************************");
                printf("\n\t|ENTRADA|-->  ");
                setbuf(stdin,NULL);
            ...
            do
            {
                ...
                printf("\t|                                                            |\n");
                printf("\t**************************************************************\n");
                printf("\t|Conta escola p?lica: %.0f vagas                               |",cad[opcao_curso-1].c);
                printf("\n\t|                                                            |");
                printf("\n\t|1?- Renda maior ou igual a 1 sal?io minimo: C1 = %.0f vagas  |",cad[opcao_curso-1].c1);
                printf("\n\t|2?- Renda menor que 1 sal?io minimo: C2 = %.0f vagas         |",cad[opcao_curso-1].c2);
                printf("\n\t|____________________________________________________________|\n");
                printf("\t|************************************************************|\n");
                printf("\t|____________________________________________________________|");
                printf("\n\t**************************************************************\n");
                printf("\t|3?- Pessoas com defici?cia: PCD = %.0f vagas                 |",cad[opcao_curso-1].pcd);
                printf("\n\t|____________________________________________________________|");
                printf("\n\t**************************************************************\n");
                printf("\t|4?- Ampla concorr?cia: A = %.0f vagas                        |",cad[opcao_curso-1].a);
                printf("\n\t|____________________________________________________________|");
                ...
                printf("\n\t _____________________________________________");
                printf("\n\t{*********************************************}\n");
                printf("\t{   Qual dessas COTAS voc?esta concorrendo?  } ");
                printf("\n\t{_____________________________________________} ");
                printf("\n\t|*******|*************************************");
                printf("\n\t|ENTRADA|-->  ");
                setbuf(stdin,NULL);
            ...
            system("cls");
            printf("\n\n|___________________________________________________________________| LISTA DE CLASSIFICA플O |________________________________________________________________________|\n");
            printf("|*******************************************************************|************************|************************************************************************|\n\n\n");
             x=-1;
            //CONFERE SE EXISTE ALGUM USU?IO CONCORRENDO PARA ESSE TIPO DE COTA
            if(opcao_tipo_cota==1)
            {
                for(i=0; i<quant_candidato; i++)
                {
                    strcpy(nome_curso,candidato[i].tipo_vaga);
                    if(strcmp(nome_curso,"C1: Renda maior ou igual a R$ 1,5 sal?ios")==0)
                    {
                        x=strcmp(nome_curso,"C1: Renda maior ou igual a R$ 1,5 sal?ios");
                        break;
                    }
                }
                ...
                {
                    printf("\n\t _____________________________________________________");
                    printf("\n\t|N? existe candidato inscrito para esse tipo de vaga!|");
                    printf("\n\t*******************|Fique esperto!|********************");
                    printf("\n\t                   ****************\n\n");
            ...
            else
            {
                ...
                if(opcao_tipo_cota==2)
                {
                    ...
                    {
                        strcpy(nome_curso,candidato[i].tipo_vaga);
                        if(strcmp(nome_curso,"C2: Renda menor que R$ 1,5 sal?ios")==0)
                        {
                            x=strcmp(nome_curso,"C2: Renda menor que R$ 1,5 sal?ios");
                            break;
                        }
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(opcao_tipo_cota==4)
                        {
                            ...
                            {
                                strcpy(nome_curso,candidato[i].tipo_vaga);
                                if(strcmp(nome_curso,"A: Ampla concorr?cia")==0)
                                {
                                    x=strcmp(nome_curso,"A: Ampla concorr?cia");
                                    break;
                                }
                            }
